...
Semester two brought a statistics course, and with it a quiz at the end of every session. I noticed the pattern early. The questions followed predictable structures, the calculations were repetitive, and the bottleneck was computation speed rather than conceptual understanding.
...
Professionally, the same instinct continues. I have built three workflow automation projects in my current role, and my workplace has been supportive, providing training on automation within the Google ecosystem that aligned well with what I was already building on my own.
...
The direction is clear. More automation, better integration, and eventually a working environment where the routine is handled by systems I have designed, and my attention is reserved for the work that genuinely needs it. AI agents are part of that picture. So is continuing to learn, both from what the tools can do and from what they cannot.
